// AUTO-GENERATED from specs/reference-data — do not hand-edit.
// Raw TSV (code<TAB>description). Parsed once in referenceData.service.ts.
export const ASCL_LANGUAGE_INDEX_RAW = `
0000	Unknown
0001	Non verbal
